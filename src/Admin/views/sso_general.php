...
<p>If you want to look through the metadata yourself, just browse here: <br> <a href="<?php echo get_home_url(null, '?saml_endpoint=metadata'); ?>" target="_blank"><?php echo get_home_url(null, '?saml_endpoint=metadata'); ?></a></p>
  <p>
